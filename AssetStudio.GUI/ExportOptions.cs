...
namespace AssetStudio.GUI
{
    public partial class ExportOptions : Form
    {
        ...
        public ExportOptions()
        {
            ...
            fairguardVer.SelectedIndex = FairGuardUtils.currentVerIndex;
        ...
        private void fairguardVer_SelectedIndexChanged(object sender, EventArgs e)
        {
            FairGuardUtils.currentVerIndex = fairguardVer.SelectedIndex;    
            Settings.Default.fairguard = fairguardVer.SelectedIndex;
        }
    }
}
