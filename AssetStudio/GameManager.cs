...
namespace AssetStudio
{
    ...
    public static class GameTypes
    {
        ...
        {
            GameType.BH3 or GameType.BH3Pre or GameType.SR or GameType.GI_Pack or GameType.TOT or GameType.Endfield_CBT2_Mobile or GameType.ArknightsEndfield => true,
            _ => false,
        };
